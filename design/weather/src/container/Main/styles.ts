...
export default styled.div<{ isMoon: boolean }>`
    .layout{
        ...
        &.morning{
            &:after{
                background-image: url("https://unsplash.com/photos/FBLGvhgVYQM/download?force=true&w=1920")
            }
        }

        &.night{
            &:after{
                background-image: url("https://unsplash.com/photos/Maf7wdHCmvo/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjY5MjEwMDA1&force=true&w=1920");
            }
        }
