...
declare interface $ { // 更新 2022/06/29
    ...
    fetch?:{
        ...
        get<T>(url: string, settingParams?: { headers?: { [key:string]:any },returnType?: retunType,[key:string]:any }):Promise<fetchClassReturnType<T> | undefined>
...
const $:$ = ((el) => {
    ...
    class FetchPromisClass extends FetchClass {
        ...
        static get = <T>(url: string, setting: { headers:{ [key:string]:any },returnType?: retunType,[key:string]:any }):Promise<fetchClassReturnType<T> | undefined> => this.fetchSetting<T>({ method: 'get',url ,...setting },true)
        
        // 更新 Promise 導出 post 方法 2022/05/01
        static post = <T>(url: string, setting: { headers:{ [key:string]:any },data:{ [key:string]:any },returnType?: retunType }):Promise<fetchClassReturnType<T> | undefined> => this.fetchSetting<T>({ method: 'post',url ,...setting },true)
        
        // 更新 Promise 導出 patch 方法 2022/05/01
        static patch = <T>(url: string, setting: { headers:{ [key:string]:any },data:{ [key:string]:any },returnType?: retunType }):Promise<fetchClassReturnType<T> | undefined> => this.fetchSetting<T>({ method: 'patch',url ,...setting },true)
        
        // 更新 Promise 導出 put 方法 2022/05/01
        static put = <T>(url: string, setting: { headers:{ [key:string]:any },data:{ [key:string]:any },returnType?: retunType }):Promise<fetchClassReturnType<T> | undefined> => this.fetchSetting<T>({ method: 'put',url ,...setting },true)
        
        // 更新 Promise 導出 delete 方法 2022/05/01
        static delete = <T>(url: string, setting: { headers:{ [key:string]:any },data:{ [key:string]:any },returnType?: retunType }):Promise<fetchClassReturnType<T> | undefined> => this.fetchSetting<T>({ method: 'delete',url ,...setting },true)
    }
    ...
    $.fetch!.get = <T>(url:string,settingParams:{ headers:{ [key:string]:any },returnType?: retunType,[key:string]:any }):Promise<fetchClassReturnType<T> | undefined> => FetchPromisClass.get<T>(url,settingParams);
