...
// import { fileUrl } from './utilities/sqlite/setting'
...
const createWindow = () => {
  ...
  // dialog.showMessageBox({ message: fileUrl, textWidth: 1200, type: 'info' })
  ...
  loadingWindow.once('show',() => {
    ...
    const topMenuSet: MenuItemConstructorOptions = process.env.APP_ENV.trim() === 'pdt' ? {
      label: 'Help',
      submenu: [
        {
          label: 'About',
