...
`),h.href),g=a("stS02"),v=a("fWYWz");i(document.querySelector(".app")).render(t(l).createElement(l.StrictMode,null,t(l).createElement(c.default,{store:v.default},t(l).createElement(s.BrowserRouter,null,t(l).createElement(m,null),t(l).createElement(g.default,null)))));